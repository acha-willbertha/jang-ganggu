...
echo -e "$green...................................             Autoscript By AndyYuda"$NC
ellow                  Autoscript By AndyYuda"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @aixxy7"$NC
echo -e "$green.........................................................."$NC
echo ''
echo -e "$Lyellow                       Tunggu 5 Saat!"$NC..........e 0 ]"
		exit 1
  fi
  i	echo "Opereen= ipv4.icanhazip\e[0m'
  #IZIN SCRIPT
  MYIP=$(curl -sS ipv4.icanhazip\e[0m'
  #IZIN SCRIPT
  MYIP=$(curl -sS ipv4.icanhazip\e[0m'
  #IZIN SCRIPT
  MYIP=$(curl -sS ipv4.icanhazip\e[0m'
  ...
  VALIDITY() {
      today=$(date -d "0 days" +"%Y-%m-%d")
          Exser}/allow/main/ipvps.conf | grep $MYIP | awk '{pr  echeep 5
              D!\e[0m"
               t\e[0m"
                       exit 0
                           fi
                                                                       ...
                                                                       exit 0
                                                                           ...
                                                                           #  your ipvps first\e[0m"
                                                                                   exit 0
                                                                                       ...
                                                                                       # Valid Scripm-%d"m/$  itUser}/allow/main/ipvps.conf | grep $MYnt.com/${GitUser}/allow/main/ipvps.conf | grep $MYnt.com/${GitUser}/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}')
                                                                                           if [[ $today < $Exp1 ]]; then
                                                                                                   echo -e "\e[32mLicensi Aktif @aixxy7\e[0mYOUR SCRIPT HAS EXPIRED!\e[0m"
                                                                                                        cho -e "\e[31mYOUR SCRIPT HAS EXPIRED!\e[0m"
                                                                                                                echo -e "\e[31mPlease renew your ipvps first\e[0m"
                                                                                                                        exit 0
                                                                                                                            fi
                                                                                                                            }
                                                                                                                            IZIN=$(curl https://raw.githubusercontent.com/${GitUser}/allow/main/ipvps.conf | awk hen
                                                                                                                              VALIDITY
                                                                                                                                 echo -e "\e[31mPl exitmkdir /var/lib/premium-scriptading...\e[0m"
                                                                                                                                 clear
                                                                                                                                 mkdir /var/lib/premium-scriptading...\e[0m"
                                                                                                                                 clear
                                                                                                                                 mkdir /var/lib/premium-scriptading...\e[0m"
                                                                                                                                 clear
                                                                                                                                 mkdir /var/lib/premium-scriptading...\e[0m"
                                                                                                                                 ...
                                                                                                                                 ═══════════════════════════════════════════\e[0m"
                                                                                                                                 echo ""
                                                                                                                                 echo -e "   \e[1;32mPlease enter the name of Provider for Srovided
                                                                                                                                 read -p "   Name : " nm
                                                                                                                                 ...
                                                                                                                                 echo -e "   \e[1;31m(Press ENTER for defultt email)\e[0m"
                                                                                                                                 read -p "   Email : " email
                                                                                                                                 ...
                                                                                                                                 sleep 1
                                                                                                                                 wget https://raw.githubusercontent.com/${GitUser}/multiport/main/install/ins-xray.sh && chmod 
                                                                                                                                 echo -e "tall \e[0m"
                                                                                                                                 sleep 1
                                                                                                                                 mult port/
                                                                                                                                 wgetiport/main/install/ohp-dropbear.sh && chmod +x ohp-dropubuserconte./ohp-dropbear.sh
                                                                                                                                 wget https://raw.githubuserconte./ohp-dropbear.sh
                                                                                                                                 wget https://raw.githubuserconte./ohp-dropbear.sh
                                                                                                                                 wget https://raw.githubuserconte./ohp-dropbear.sh
                                                                                                                                 wget https://raw.githubuserconte./ohp-dropbear.sh
                                                                                                                                 wget https://raw.githubuserconte./ohp-dropbear.sh
                                                                                                                                 ...
                                                                                                                                 wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/${GitUserblmultiport/main/nginx.conf"
                                                                                                                                 ...
                                                                                                                                 echo ""  | tee -a log-install.txt
                                                                                                                                 echo "    [INFORMASI Sqd, Bdvp, Ngnx]" | tee -a log-install.a log3128, 8000 (limit to IP Server)"  | t           : 3128, 8000 (limit to IP Server)"  | t           : 3128, 8000 (limit to IP Server)"  | tee -a log-install.txt
                                                                                                                                 echo "   - Badvpn                  : 7100, 7200, 7300"  | tee -a log-install.txt
                                                                                                                                 echo "   - Nginx                   : 81"  | tee -a log-install.txt
                                                                                                                                 echo ""  | tee -a log-install.txt
                                                                                                                                 echo "    [INFORMASI XRAY]"  | tee -a log-install.txt
                                                                                                                                 echo "    ----------------" | tee -a log-install.txt
                                                                                                                                 echo "i  - Xray Vmess Ws Tls       : 443"  | tee -a log-install.txt
                                                                                                                                 ...
                                                                                                                                 echo "   - Autoreboot On 05.00 GMT +7" | tee -a -ag-ig-install.txt
                                                                                                                                 ec"   - Autobackup Data" | tee -a log-install.txt
                                                                                                                                 echo "   - Restore Data" | tee -a log-install.txt
                                                                                                                                 echo "   - Auto Delete Expired Account" | tee -a log-install.txt
                                                                                                                                 echo "   - Full Orders For Various Services" | tee -a log-install.txt
                                                                                                                                 echo "   - White Label" | tee -a log-log-instal═.txt═════════════Autoscript By Aixho -e "\e[1;32m══════════════════Autoscript By Aixho -e "\e[1;32m══════════════════Autoscript By Aixxy7══════════════════\e[0m" | tee -a log-install.txt
                                                                                                                                 sleep 7
                                                                                                                                 clear
                                                                                                                                 echo ""
                                                                                                                                 echo -e "  ---.\e[0m"
                                                                                                                                 echo -e "    \e[1;32m|     SU-------------.\e[0m"
